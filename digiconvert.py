...
unitmultipliers = {
    ...
    "weight": {
        ...
        "🌌w": 954448800000000000000000000000000000000000000,
...
orders = {
    ...
    "metricweight": {
        0.000000000000000000000000001: "yg",
        0.000000000000000000000001: "zg",
        0.000000000000000000001: "ag",
        0.000000000000000001: "fg",
        0.000000000000001: "pg",
        0.000000000001: "ng",
        0.000000001: "μg",
        0.000001: "mg",
        0.001: "g",
        1: "kg",
        1000: "t",  # Stone intentionally skipped
        1000000: "kt",
        1000000000: "Mt",
        1000000000000: "Gt",
        1000000000000000: "Tt",
        1000000000000000000: "Pt",
        1000000000000000000000: "Et",
        1000000000000000000000000: "Zt",
        1000000000000000000000000000: "Yt",
        954448800000000000000000000000000000000000000: "🌌w",
        200000000000000000000000000000000000000000000000000000: "uniw"
    },
    "usweights": {
        0.000000000000000000000000001: "yg",
        0.000000000000000000000001: "zg",
        ...
        0.4636: "lb",
        907.185: "tn",
        5972000000000000000000000: "🌎w",
        1988435000000000000000000000000000: "☀️w",
        954448800000000000000000000000000000000000000: "🌌w",
        200000000000000000000000000000000000000000000000000000: "uniw"
    }
}
...
def toShoeSize(VUpair):
    ...
    if child:
        shoesize = f"Children's {shoesize}"
    return shoesize
...
def fromShoeSize(size):
    ...
    # TODO: Move unit constant
    inch = Decimal(25400)  # Unit constant
    out = inches * inch
    return out
...
def convert(VUpair, unitto):
    ...
    if unitfromKey in unitmultipliers["length"]:
        unittype = "length"
    if unitfromKey in unitmultipliers["weight"]:
        unittype = "weight"
    if unitfromKey in unitmultipliers["area"]:
        unittype = "area"
    ...
    if unittoKey not in unitmultipliers[unittype]:
